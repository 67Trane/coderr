...
urlpatterns = [
    ...
    path("offerdetails/<int:pk>/", OfferDetailView.as_view(), name="offerdetails-details"),
    ...
    path("completed-order-count/<int:pk>/", OrderCompletedView.as_view(), name="completed-order-count"),
]

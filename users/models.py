...
class Profile(models.Model):
    ...
    file = models.ImageField(upload_to="profile_pictures/", null= True, blank=True, help_text="Profilbild.")
    location = models.CharField(max_length=255, blank=True, help_text="Adresse oder Standort")
    tel = models.CharField(max_length=30, blank=True, help_text="Telefonnummer z.B. +49 123 4567 890")
